                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="announcement-card p-3 mb-3">
                            ...
                            <p class="text-muted mb-2"><i class="bi bi-calendar"></i> 1 Agustus 2023 - 30
                                Agustus 2023</p>
                            <p>Pembayaran SPP untuk semester ganjil tahun ajaran 2023/2024 telah dibuka.
                                Harap segera melakukan pembayaran sebelum batas waktu yang ditentukan.</p>
                        </div>

                        <div class="announcement-card p-3 mb-3">
                            <h5>Pembayaran KKN Periode Juli 2023</h5>
                            <p class="text-muted mb-2"><i class="bi bi-calendar"></i> 15 Juli 2023 - 15
                                Agustus 2023</p>
                            <p>Bagi mahasiswa yang akan mengikuti KKN periode Juli 2023, pembayaran biaya
                        ...
                        <div class="announcement-card p-3">
                            ...
                            <p class="text-muted mb-2"><i class="bi bi-calendar"></i> 1 September 2023 - 30
                                September 2023</p>
                            <p>Pembayaran ujian skripsi untuk periode wisuda Oktober 2023 telah dibuka.
                                Pastikan semua persyaratan telah dipenuhi sebelum melakukan pembayaran.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between mt-1">
                                <small class="text-muted">Tersisa 5 hari lagi</small>
                                <small class="text-danger">85% tenggat waktu</small>
                            </div>
                        </div>
                        ...
                        <a href="{{ url('pembayaran') }}" class="btn btn-outline-secondary w-100">
